...
const OPEN_AI_DESIRED_OUTPUT_FORMAT = [
  ...
  "- (list) Provide recommendations for optimizing test execution timings. Highlight tests with unusually long durations and suggest potential reasons and fixes..",
